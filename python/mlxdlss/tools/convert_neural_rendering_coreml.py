...
the MLX-DLSS source repository.
"""
...
from mlxdlss import model as neural_rendering_reference
import torch
from safetensors import safe_open
from torch import nn

IDENTIFIER = "org.mlxdlss.external.neural-rendering-transformer.coreml"
...
def convert_weights(
    ...
    *,
    ...
    converted.author = "MLX-DLSS contributors"
    converted.short_description = (
        f"Recovered neural-rendering head ({height}x{width}, {precision})"
    )
    converted.user_defined_metadata["com.mlxdlss.identifier"] = IDENTIFIER
    converted.user_defined_metadata["com.mlxdlss.architecture"] = ARCHITECTURE
    converted.user_defined_metadata["com.mlxdlss.compute_precision"] = precision
    converted.user_defined_metadata["com.mlxdlss.io_type"] = "multiarray"
    converted.user_defined_metadata["com.mlxdlss.input_layout"] = "nchw"
    converted.user_defined_metadata["com.mlxdlss.checkpoint_sha256"] = _sha256(
        weights_path
    )
    converted.user_defined_metadata["com.mlxdlss.source_format"] = source_format
