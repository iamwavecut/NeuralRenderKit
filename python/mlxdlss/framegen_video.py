...
def interpolate_video(
    ...
    *,
    ...
    if options.backend == "mlxdlss":
        ...
        stream = MLXDLSSFrameGenStream(options.mlxdlss_weights, info.width, info.height, factor=options.factor, precision=options.mlxdlss_precision,
                                   mlxdlss=options.mlxdlss, batch=options.batch)
