#!/usr/bin/env python3
"""Wrap external logical neural-rendering weights in an NRK model package."""
...
IDENTIFIER = "org.neuralrenderkit.external.neural-rendering-transformer"
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Package external logical neural-rendering weights for NeuralRenderKit."
    )
