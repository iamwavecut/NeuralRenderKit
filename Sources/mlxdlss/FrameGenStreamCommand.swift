...
/// `mlxdlss framegen-stream --weights framegen.safetensors --width W --height H [--factor N] [--batch P] [--format u8|f32] [--precision float16|float32]`
///
/// Frame server for hosts that decode and encode video themselves (the Python
/// `mlxdlss-video framegen --backend mlxdlss`): RGB frames (`H*W*3` values; `--format u8`
