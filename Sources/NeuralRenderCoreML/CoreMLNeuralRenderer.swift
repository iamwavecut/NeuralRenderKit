  ...
  @unchecked Sendable
{
  ...
  init(modelURL: URL, configuration: CoreMLBackendConfiguration) async throws {
    ...
    self.metadata = CoreMLModelMetadata(
      identifier: creatorDefined?["com.neuralrenderkit.identifier"],
      architecture: creatorDefined?["com.neuralrenderkit.architecture"],
      checkpointSHA256: creatorDefined?["com.neuralrenderkit.checkpoint_sha256"],
      computePrecision: creatorDefined?["com.neuralrenderkit.compute_precision"],
      reductionPrecision: creatorDefined?[
        "com.neuralrenderkit.reduction_precision"
      ],
      ioType: creatorDefined?["com.neuralrenderkit.io_type"]
    )
  }
